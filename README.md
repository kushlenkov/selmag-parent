...
SelMag Platform - это современная облачная плаформа для электронной коммерции, построенная на микросервисной архитектуре с использованием Spring Cloud 2023.0.0 и Spring Boot 3.2.3.

**Ключевые компоненты:**
- **API Gateway** - единая точка входа для всех клиентских запросов
- **Service Discovery** (Eureka) - автоматическое обнаружение и регистрация сервисов
- **Config Server** - централизованное управление конфигурациями
- **Admin Server** - мониторинг и управление приложениями
- **Customer App** - веб-приложение для покупателей
- **Manager App** - панель управления для сотрудников
- **Catalogue Service** - управление товарами и категориями
- **Feedback Service** - система отзывов и рейтингов

**Преимущества:**
- Масштабируемая микросервисная архитектура
- Высокая доступность и отказоустойчивость
- Гибкость развертывания (облако/on-premise)
- Современный стек технологий (Java 21, Spring Boot 3.2.3)
- Полная документация API (Spring REST Docs)
